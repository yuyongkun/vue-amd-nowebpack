...
(function (factory) {
  ...
  $.extend(prototype, {
    ...
    view: function (index) {
      ...
      //加载完成显示图片
      if (!$image[0].complete) {
          var IMG = '<img id="circle-loading" style="position: fixed; width: 50px; height: 50px; left: 50%; top:50%;margin-left: -25px;margin-top:-25px;z-index: 9999999;" src="/assets/js/plugs/viewer/oval.svg" alt="">';
          if (navigator.userAgent.indexOf('MSIE') >= 0) {//ie
              IMG = '<img id="circle-loading" style="position: fixed; width: 37px; height: 37px; left: 50%; top:50%;padding:5px;margin-left: -18px;margin-top:-18px;background:#fff;border-radius:5px;z-index: 9999999;" src="/assets/images/loading/ie-loading.gif" alt="loading">';
          }
