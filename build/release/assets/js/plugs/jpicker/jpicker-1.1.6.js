          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            initialize =
              function()
              {
                ...
                var controlHtml='<table class="jPicker" cellpadding="0" cellspacing="0" style="display: none"><tbody>' + (win.expandable ? '<tr><td class="Move" colspan="5">&nbsp;</td></tr>' : '') +
                    '<tr class="color-picker-head"><td class="Button">颜色选择器<input type="button" class="Cancel" value="x" title="关闭弹框"></td></tr><tr><td rowspan="9"><div class="Map"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span>' +
                    '<img src="' + images.clientPath + images.colorMap.arrow.file + '" class="Arrow"/></div></td><td rowspan="9"><div class="Bar"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span>' +
                    '<span class="Map3">&nbsp;</span><span class="Map4">&nbsp;</span><span class="Map5">&nbsp;</span><span class="Map6">&nbsp;</span>' +
                    '<img src="' + images.clientPath + images.colorBar.arrow.file + '" class="Arrow"/></div></td><td colspan="2" class="Preview">'+
                    '<div><span class="Active" title="' + localization.tooltips.colors.newColor + '">&nbsp;</span><span class="Current" title="' + localization.tooltips.colors.currentColor + '">&nbsp;</span></div>' +
                    '</td><td rowspan="9" class="Button">' +
//                    '<span class="close Cancel" title="关闭弹框">x</span>' +
                    '<input type="button" class="Ok" value="确定">'+
//                    '<input type="button" class="Cancel" value="x" title="关闭弹框">'+
...
//                    setImg.call($this, preview.find('div:first'), images.clientPath + 'preview-opacity.png');
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: '/Public/Home/assets/js/plugs/jpicker/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
