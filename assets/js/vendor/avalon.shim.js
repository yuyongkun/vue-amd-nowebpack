...
var keywords = [
    ...
    "package,private,protected,template,short,static,super,synchronized",
...
// 通过它们保持一个下上文，让用户能调用$page,$first,$last,$remove,$key,$val,$outer等属性与方法
...
var filters = avalon.filters = {
    ...
    camelize: camelize,
    //https://www.owasp.org/page.php/XSS_Filter_Evasion_Cheat_Sheet
            ...
            if (match) { //处理a标签的href属性，img标签的src属性，form标签的action属性
                ...
                if (reg) {
                    a = a.replace(reg, function(s, name, value) {
                        ...
                        return name + "=" + quote + "javascript:;" + quote// jshint ignore:line
                    })
                }
            }
